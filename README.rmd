---
# <!-- README.Rmd generates README.md. Any edits should be made to the .Rmd file -->
output:
  github_document:
    html_preview: false
---
...
This plan uses pre-set values for `hit_frac_cutoff` and `I-value`, and the "one-to-one" method of ortholog pruning. To test the effects of using different values and pruning methods, see the [baitfindR_complex example project](https://github.com/joelnitta/baitfindR_complex).
